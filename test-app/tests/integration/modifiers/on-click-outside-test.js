...
module('Integration | Modifier | on-click-outside', function (hooks) {
  ...
  hooks.afterEach(function () {
    // Cleanup fails with Ember 3.8 for some reason
  ...
  test('real-world scenario', async function (assert) {
    ...
    await render(hbs`
        <button data-test-open type="button" {{on "click" this.open}}>
          Toggle popover
        </button>
